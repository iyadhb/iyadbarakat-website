...
By every adoption measure, this technology has crossed the chasm. In professional services specifically, [Thomson Reuters' 2026 research](https://www.thomsonreuters.com/en-us/posts/technology/ai-in-professional-services-report-2026/) found that around 40% of professionals say their organisation now uses generative AI — nearly double the year before. Most weekly users expect it to be central to how they work within five years. On paper, the battle for adoption is over.

And yet almost nobody can tell you what they are getting for it. In the same body of research, only about 18% of firms track the return on their AI investment at all; a further 40% don't even know whether anyone is measuring it. On the agent front, [McKinsey's 2026 work](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/tech-forward/state-of-ai-trust-in-2026-shifting-to-the-agentic-era) puts the share of enterprise *functions* actually using AI agents at roughly one in ten, despite the enormous noise. Gartner has gone further and forecast that more than 40% of agentic-AI projects will be scrapped before the end of 2027 — not because the technology fails, but because of unclear value and weak controls. Security and risk, not capability, is the barrier firms name most often.
...
If you want the ground-level mechanics, I've written separately on [why structure beats one-liners](/blog/how-consultants-should-prompt-ai/) and on [using GOAL to brief in fifteen seconds](/blog/goal-prompt-framework/). This piece is the map; those are the technique.
...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="720" viewBox="0 0 1200 720" role="img" aria-label="A 2x2 matrix for deciding what to delegate to AI agents versus keep human, by how reversible a mistake is and how much judgment it needs">
    <rect width="1200" height="720" fill="#FAF7F2"/>
    <text x="600" y="54" text-anchor="middle" font-family="'Playfair Display', Georgia, serif" font-size="32" font-weight="700" fill="#1F1D1A">What to delegate, and what to own</text>
    <text x="600" y="88" text-anchor="middle" font-family="Inter, Arial, sans-serif" font-size="15" fill="#6B675F">Sort every task by two questions before you hand it to an agent.</text>
    <text x="531" y="126" text-anchor="middle" font-family="Inter, Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="1.5" fill="#6B675F">HARD TO REVERSE</text>
    <text x="889" y="126" text-anchor="middle" font-family="Inter, Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="1.5" fill="#6B675F">EASY TO REVERSE</text>
    <text x="345" y="256" text-anchor="end" font-family="Inter, Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="1.5" fill="#6B675F">HIGH</text>
    <text x="345" y="274" text-anchor="end" font-family="Inter, Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="1.5" fill="#6B675F">JUDGMENT</text>
    <text x="345" y="519" text-anchor="end" font-family="Inter, Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="1.5" fill="#6B675F">LOW</text>
    <text x="345" y="537" text-anchor="end" font-family="Inter, Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="1.5" fill="#6B675F">JUDGMENT</text>
    <rect x="360" y="140" width="342" height="247" rx="12" fill="#FFFFFF" stroke="#E3DED3" stroke-width="1.5"/>
    <text x="384" y="188" font-family="Inter, Arial, sans-serif" font-size="19" font-weight="700" fill="#1F1D1A">Own it — you decide</text>
    <text x="384" y="224" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">The recommendation, the problem</text>
    <text x="384" y="246" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">framing, the number you'll defend.</text>
    <text x="384" y="284" font-family="Inter, Arial, sans-serif" font-size="14.5" font-style="italic" fill="#9A968C">AI widens your options; you make</text>
    <text x="384" y="306" font-family="Inter, Arial, sans-serif" font-size="14.5" font-style="italic" fill="#9A968C">the call.</text>
    <rect x="718" y="140" width="342" height="247" rx="12" fill="#FFFFFF" stroke="#E3DED3" stroke-width="1.5"/>
    <text x="742" y="188" font-family="Inter, Arial, sans-serif" font-size="19" font-weight="700" fill="#1F1D1A">AI-assisted, human-led</text>
    <text x="742" y="224" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">Explore options, ideate,</text>
    <text x="742" y="246" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">pressure-test your thinking.</text>
    <text x="742" y="284" font-family="Inter, Arial, sans-serif" font-size="14.5" font-style="italic" fill="#9A968C">Lean on it freely — you still</text>
    <text x="742" y="306" font-family="Inter, Arial, sans-serif" font-size="14.5" font-style="italic" fill="#9A968C">choose what survives.</text>
    <rect x="360" y="403" width="342" height="247" rx="12" fill="#FFFFFF" stroke="#E3DED3" stroke-width="1.5"/>
    <text x="384" y="451" font-family="Inter, Arial, sans-serif" font-size="19" font-weight="700" fill="#1F1D1A">Automate, then verify</text>
    <text x="384" y="487" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">Consequential but checkable —</text>
    <text x="384" y="509" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">a model, a data pull, a filing.</text>
    <text x="384" y="547" font-family="Inter, Arial, sans-serif" font-size="14.5" font-style="italic" fill="#9A968C">The agent drafts; a human signs</text>
    <text x="384" y="569" font-family="Inter, Arial, sans-serif" font-size="14.5" font-style="italic" fill="#9A968C">off before it ships.</text>
    <rect x="718" y="403" width="342" height="247" rx="12" fill="#FBEADF" stroke="#D9552B" stroke-width="2"/>
    <text x="742" y="451" font-family="Inter, Arial, sans-serif" font-size="19" font-weight="700" fill="#C0451F">Delegate to agents</text>
    <text x="742" y="487" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">First-draft research, formatting,</text>
    <text x="742" y="509" font-family="Inter, Arial, sans-serif" font-size="14.5" fill="#6B675F">reconciliation, summarising.</text>
    <text x="742" y="547" font-family="Inter, Arial, sans-serif" font-size="14.5" font-weight="700" fill="#C0451F">Hand it over — you're leaving</text>
    <text x="742" y="569" font-family="Inter, Arial, sans-serif" font-size="14.5" font-weight="700" fill="#C0451F">value on the table if you don't.</text>
  </svg>
  <figcaption>The two questions that sort the work. Most disappointment with AI comes from getting this backwards — automating the judgment and hand-cranking the drudgery.</figcaption>
</figure>
...
When you want the full system, I've made the six frameworks free — you can [get all six here](/frameworks/). And the hundred ready-to-run prompts built on them, each tagged with its framework and adaptation notes, come with the book as the companion [Prompt Vault](/vault/) for readers.
