...
When you want the full system, I've made the six frameworks free — you can [get all six here](/frameworks/). And if you'd rather work from a hundred ready-to-run prompts built on them, each tagged with its framework and adaptation notes, that's [the Vault](/vault/).
